...
?><img class='item_block_image item_block_image_visible' src='<?php echo $imagePath ?>' alt="Navigation - link to <?php echo $target ?>"><div class='item_block_text'><div><?php echo getTitleLabel($title) ?></div><?php if($external) { ?><div class='external'><img src='/resource/external.svg' alt="Navigation - link to <?php echo $target ?>"></div><?php } ?></div></a><?php
	}
?>
